<?php
if ( ! class_exists( 'brgridlist_free_funnels' ) ) {
	class brgridlist_free_funnels {
		...
		public function spring_premium_days_2026(): void {
			$plugin_version_capability = apply_filters( 'brfr_get_plugin_version_capability_list_grid', 0 );
			$type = ( $plugin_version_capability >= 15 ) ? 'paid' : 'free';

			$name       = 'spring_premium_days_2026';
			$media      = '?utm_source=' . $type . '_plugin&utm_medium=admin_notice&utm_campaign=spring_2026&utm_content=top_banner_cta&utm_term=gridlist';
			...
			if ( ! $is_closed and $start_time <= time() and $end_time > time() ) {
				...
				<div class="berocket-notice-template-big" style="">
					<div class="berocket-notice-description-container">
						...
						<h3>Improve product browsing and increase engagement</h3>
						<ul style="font-size: 16px">
							<li>Switch between grid and list layouts for better shopping experience</li>
							<li>Advanced list styles with customizable layouts and presets</li>
							<li>Flexible display options to match your store design and UX</li>
						</ul>
					...
					<div class="berocket-notice-actions-container">
						...
						<div class="berocket-notice-buttons-container">
							<a href="https://berocket.com/woocommerce-grid-list-view/' . $media . '" 
							   class="button notice-action-link not_berocket_button" target="_blank" 
							   style="position: static; display: inline-block; right: 0; top: 0; margin: 0;font-size: 24px;padding-left: 25px;padding-right: 25px;">Upgrade Grid/List → 30% OFF</a>
